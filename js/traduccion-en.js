...
const traduccionEn = {
  ...
  h3Quienes: "<abbr title='Instituto Nacional de Técnica Aeroespacial'>INTA</abbr> RF power laboratory",
  h3Introduccion:"Introduction on <abbr title='Radio frecuency'>RF</abbr> High-Power effects",
  h3NuestrosAmplificadores: "Our Amplifiers",
  h3ListadoEquipo: "We also have ...",
  h3NuestraSalaLimpia: "Our clean room",
  h3NuestrasCamarasVacio: "Our vacuum chambers",
  h3CamaraMontena: "Montena Anechoic <abbr title='Passive Intermodulation'>PIM</abbr> Chamber",
  ...
  multimediaPdfMontena: "PDF of the Montena anechoic <abbr title='Passive Intermodulation'>PIM</abbr> chamber",
  contacto: "Contact",
  contactoResponsable: "Service Manager",
  contactoTelefonos: "Phone Numbers",
  contactoLaboratorio: "Laboratory",
  contactoLaboratorioSpan: "<abbr title='Radio frecuency'>RF</abbr> Power Laboratory",
  contactoArea: "Area",
  ...
  contactoLocalizacionSpan: "<abbr title='Instituto Nacional de Técnica Aeroespacial'>INTA</abbr> Central Headquarters Torrejón de Ardoz",
  direccionEmpresa: "© 2025 <abbr title='Instituto Nacional de Técnica Aeroespacial'>INTA</abbr> – Radio frequency Power Laboratory",
  ...
  textoQuienes:`
    <p itemprop='description'>
      <abbr title='Instituto Nacional de Técnica Aeroespacial'>INTA</abbr>'s RF power testing laboratory has facilities for conducting electronic and <abbr title='Radio frecuency'>RF</abbr> tests, analyses, and trials aimed at evaluating, qualifying, and certifying equipment, subsystems, and systems for aerospace, military, and civil applications.
    </p>
    <p>
    ...
    <p>
      The laboratories where <abbr title='Radio frecuency'>RF</abbr> power tests are performed have an established quality system that complies with the UNE-EN ISO/IEC 17025 standard for testing laboratories.
    </p>
    <p>
  ...
  textoIntroduccion:`
    <p>
      Commercial and scientific satellites are equipped with greater on-board radio frequency (<abbr title='Radio frecuency'>RF</abbr>) power to respond to the increasing demand of data volumes, which necessitates more frequent transmissions at higher rates. This, however, increases the likelihood of <abbr title='Radio frecuency'>RF</abbr> voltage breakdown and unwanted interferences, reducing and even endangering payload performance. Therefore, high-power density in <abbr title='Radio frecuency'>RF</abbr> components requires careful design, analysis and ground testing.
    </p>
    <p>
      <abbr title='Radio frecuency'>RF</abbr> power on-board spacecraft has been increased significantly over the past few years and it is expected that this trend will continue for the next generation of satellites. Some telecommunication satellites are equipped with a large number of channels, combined into a single antenna feed (multicarrier operation). Remote sensing <abbr title='Radio frecuency'>RF</abbr> payloads require higher power transmission on single antenna array (single carrier operation). Additionally, navigation satellite fleets have also seen a progressive power enhancement.
    </p>
    <p>
      Multipactor and Corona effect are two discharge phenomena which may happen in <abbr title='Radio frecuency'>RF</abbr> components on-board spacecraft. Voltage breakdown occurs when the generation of electrons exceeds the removal of electrons from the component surface or the intermediary gas. In the event of <abbr title='Radio frecuency'>RF</abbr> voltage breakdown, the two main electron generation mechanisms are ionisation of the gas by electron collision (Corona), and secondary electron emission from the surfaces (Multipactor). This last phenomenon is very much related to the Secondary Emission Yield properties of the material (SEY).
    </p>
    <p>
      Since the physics involved in these two phenomena is different, separate approaches have been followed over the last few decades to eliminate, or at least reduce, the risk of discharge on board <abbr title='Radio frecuency'>RF</abbr> equipment and components. Despite the efforts, the threat of <abbr title='Radio frecuency'>RF</abbr> voltage breakdown is still a serious issue when designing and manufacturing <abbr title='Radio frecuency'>RF</abbr> components for space applications.
    </p>
    <p>
    ...
    <p>
      Power Handling testing involves subjecting the device to a maximum continuous <abbr title='Radio frecuency'>RF</abbr> power (CW) regime under vacuum and extreme temperature conditions, in order to verifying the device under test’s capabilities to deal with the large amounts of heat that the Joule effect produces in a harsh environments .
    </p>
  `,
  textoMultipactor:`
    Multipactor is a weak discharge phenomenon threating radio-frequency circuits on-board the spacecraft. Multipactor occurs under high vacuum conditions when the field and impact accelerate free electrons, captured by the associated <abbr title='Radio frecuency'>RF</abbr> electric field, on the circuit structure with sufficient energy to liberate secondary electrons. As the field changes polarity, these electrons accelerate, impact on the opposite surface and again liberate secondary electrons. As the process is repeated millions of times per second, an avalanche of electrons rapidly grows, initiating a multipactor discharge. The immediate consequence of this process is in the shape of degradation of the <abbr title='Radio frecuency'>RF</abbr> signal; however, it can lead to surface erosion and eventually, the breakdown of the transmission path.
  `,
  textoCorona:`
    Ionisation breakdown (Corona) occurs at higher pressures than those for multipactor. During a Corona discharge, electrons are produced through collisions between electrons and gas molecules. This type of discharge is dependent not only on pressure but also on the type of gas. The phenomenon starts when a concentration of free electrons is generated through resonant collisions between electrons and gas molecules. The electrons accumulate in a charge cloud that is swept between or along the conductor surfaces. With each pass of the electric field, the electrons interact with the molecules causing additional charge accumulation and thermal dissipation. This process will continue until the energy density is sufficient to form a plasma arc between conductors. As a result, the damage caused in the <abbr title='Radio frecuency'>RF</abbr> path is quite severe.
  `,
  textoPim:`
  ...
  textoNuestrosAmplificadores:`
    ...
    Each amplifier has been selected for its performance in critical test environments, including thermal vacuum chambers, multipactor test benches, and <abbr title='Radio frecuency'>RF</abbr> connector and material validation systems. The table below presents the key specifications of our available models, making it easier to choose the most suitable equipment based on the technical application and required operating range.
  `,
  textoListadoEquipo1:"Two <abbr title='Vector Network Analyzer'>VNA</abbr> systems with capacity up to 50 GHz",
  textoListadoEquipo2:"State-of-the-art spectrum analyzers reaching up to 67 GHz",
  textoListadoEquipo3:"Duplicated low-noise amplifiers (<abbr title='Low Noise Amplifier'>LNA</abbr>s), operational up to 60 GHz",
  textoListadoEquipo4:"Wide range of <abbr title='Radio frecuency'>RF</abbr> generators, covering up to 50 GHz",
  textoListadoEquipo5:"Over 40 power measurement channels, each capable of up to 50 GHz",
